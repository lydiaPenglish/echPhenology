...
### Study Questions
  ...
  3. Does the repeatability of either of these traits depend on the origin site of these plants?
...
r2 <- rpt(startNum ~ year + (1|site), grname = "site", data = phen_1996, datatype  = "Gaussian",
          nboot = 100, npermut = 100, parallel = TRUE) # why is this a singular fit?
summary(r2)
plot(r2)
